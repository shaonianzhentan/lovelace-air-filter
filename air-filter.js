...
function getDialog() {
  ...
  div.innerHTML = `        
    <style>
      ...
      .dialog-panel .dialog-attr{width:50%;box-sizing: border-box;border-right:1px solid #444;border-bottom:1px solid #444;padding:20px 0;}
...
function setDialog(div, { filter_hours_used, purify_volume, led }) {
  ...
  div.querySelector('.var-led').textContent = led
}
